				...
				<xsl:for-each select="FMSDOM_GOODS/FMSDOM_GOOD">
					...
					<xsl:for-each-group select="$linkedTR/FMSDOM_TRANSPORT" group-by="@KEY">	
						...
						<SEG TYPE="LOC">
							...
							<ELEMENT>
								<FIELD>
									<xsl:value-of select="FMSDOM_TRANSPORT_STOPS/FMSDOM_TRANSPORT_STOP[PLACE_QUALIFIER = '11'][1]/LOCATION_OWNING_CODE"/>
								</FIELD>
								<FIELD/>
								<FIELD/>
								<FIELD>
									<xsl:value-of select="FMSDOM_TRANSPORT_STOPS/FMSDOM_TRANSPORT_STOP[PLACE_QUALIFIER = '11'][1]/LOCATION_NAME"/>
								</FIELD>
							</ELEMENT>
						</SEG>
						<SEG TYPE="DTM">
						...
						<SEG TYPE="DTM">
							<ELEMENT>
								<FIELD>132</FIELD>
								<FIELD>
									<xsl:value-of select="replace(tokenize(FMSDOM_TRANSPORT_STOPS/FMSDOM_TRANSPORT_STOP[PLACE_QUALIFIER = '11'][1]/START_TIME, 'T')[1], '-', '')"/>
								</FIELD>
								<FIELD>102</FIELD>
							</ELEMENT>
						</SEG>
						<SEG TYPE="DTM">
							<ELEMENT>
								<FIELD>178</FIELD>
								<FIELD>
									<xsl:value-of select="replace(tokenize(FMSDOM_TRANSPORT_STOPS/FMSDOM_TRANSPORT_STOP[PLACE_QUALIFIER = '11'][1]/ACTUAL_TIME, 'T')[1], '-', '')"/>
								</FIELD>
								<FIELD>102</FIELD>
							</ELEMENT>
						</SEG>
